    ...
    def main():
        ...
        def render_deepdreamvideo(filename):
            ...
            for i, im in enuVid:
                ...
                deepDreamImg = render_deepdream(T(layer)[:, :, :, channel], img0, iter_n=100, octave_n=4, step=1.5,
                                                octave_scale=1.4)
            ...
            os.system(
                "ffmpeg -r 30 -f image2 -s 1920x1080 -i out/%d.png -vcodec libx264 -crf 25  -pix_fmt yuv420p test.mp4")
